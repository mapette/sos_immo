...
function FicheIncStatus(props) {
  ...
  let [status, setStatus] = useState(lib.determineStatus(props.incident.inc_affect_date, props.incident.inc_fin_date))

  // console.log('date', props.incident.inc_affect_date, props.incident.inc_fin_date)
  // console.log('status : ', status)
  //console.log('incStatus', props.incident)
  return (
    <div>
